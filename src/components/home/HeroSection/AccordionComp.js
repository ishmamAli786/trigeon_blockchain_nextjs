        ...
        <ul>
          <Link href="/accordionSections/section1">
            <li onMouseEnter={() => setShow(true)} onMouseLeave={() => setShow(false)}>
              ...
              <div>
                <a href="#" className="sliderLink tst">
                  <h2>Trigan Blockchain</h2>
                  <p>The first real-world relevant blockchain Designed as a fairer more powerful solution to the needs of <br /> urban communities.
