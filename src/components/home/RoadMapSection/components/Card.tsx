    ...
    <div className=" mb-5 before:table before:content-[''] after:clear-both after:table after:content-['']">
      <a href="http://asia.vasilis-tsirimokos.com/japan.html">
        <div
          ...
          } post group relative w-[48%] overflow-hidden bg-[rgba(84,84,84,0.6)] py-[50px] text-center text-5xl uppercase text-white transition-all  duration-[0.5s] before:absolute before:bottom-[54%]  before:h-[55%] before:origin-[100%,0] before:bg-[#f2f2f2] before:pl-[3%]  before:content-[''] after:absolute after:top-[54%] after:h-[55%] after:origin-[100%,0] after:bg-[#f2f2f2] after:pl-[3%] after:content-[''] group-hover:!text-black`}
        >
          <i
