    ...
    <GlobalLayout>
      <header className="relative h-[100vh] w-full overflow-hidden ">
        <video
          ...
          preload="auto"
        >
          <source src="/videos/dao.mp4" type="video/mp4" />
        </video>
      ...
      <section className=" center align-center relative flex w-full flex-col flex-wrap justify-center overflow-hidden bg-[url('/images/endless-constellation.png')] bg-[length:300px_300px] bg-repeat py-10">
        <div className="self-center bg-white px-5 drop-shadow-2xl md:w-[50%]">
          ...
          <p>
            Our DAO (Decentralised Autonomous Organisation) is as revolutionary
            as it is unique. It’s purpose goes far beyond that of previous DAO
            implementations. It will have responsibility for all facets of our
            economy and government. Our DAO never sleeps, is always fair and
            cannot be corrupted.
          </p>
          <p>
